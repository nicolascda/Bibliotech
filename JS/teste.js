    ...
    for(let i = 0; i < resultado.length; i++)
    {
        ...
        lugar.innerHTML += `
            <div class="card" id="MultipleDivs" data-genero="${genero}">
                ...
                <svg data-id="${id}" xmlns="http://www.w3.org/2000/svg"height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3" class="tag"><path d="M440-120v-320H120v-80h320v-320h80v320h320v80H520v320h-80Z"/>
                </svg>
                <p class="reservar" >Indisponível</p>
